...
// Manual line-clamp via inline style — doesn't depend on Tailwind's
// line-clamp plugin/version, so it works reliably everywhere.
            ...
            >
              {visibleEpisodes.map((episode, index) => {
                ...
                return (
                  ...
                  >
                    {/* IMAGE */}
                    <div className="relative w-full aspect-video rounded-lg sm:rounded-xl overflow-hidden bg-black/30">
                      <img
                        src={thumbnail}
                    ...
                    {episode.synopsis && (
                      <p
                        className="text-xs text-gray-400 mt-1.5 px-0.5"
                        style={clampStyle(2)}
                      >
                        {episode.synopsis}
                      </p>
