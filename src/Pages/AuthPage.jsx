        ...
        <div className="flex flex-col min-h-screen bg-[#0b132b]">
                    ...
                    >
                        ...
                        <div className="flex flex-col space-y-3">
                            <button className="flex items-center justify-center w-full border border-white/20 rounded-lg py-3 hover:bg-white/10 transition">
                                <FaGoogle className="mr-2 text-[#EA4335]" /> Continue with Google
                            </button>
                            <button className="flex items-center justify-center w-full border border-white/20 rounded-lg py-3 hover:bg-white/10 transition">
                                <FaFacebookF className="mr-2 text-[#1877F2]" /> Continue with Facebook
                            </button>
                            <button className="flex items-center justify-center w-full border border-white/20 rounded-lg py-3 hover:bg-white/10 transition">
            ...
            <footer className="mt-auto py-4 text-center text-gray-400 text-xs sm:text-sm opacity-70">
                <p>
                    ...
                    <span className="text-[#FFD166] font-semibold">RetroToonz</span>. All rights reserved.
                </p>
